...
class LangConv(object):
    @staticmethod
    def simple_to_tradition(data):
        return Converter("zh-hant").convert(data.decode("utf-8")).encode("utf-8")

    @staticmethod
    def tradition_to_simple(data):
        return Converter("zh-hans").convert(data.decode("utf-8")).encode("utf-8")
